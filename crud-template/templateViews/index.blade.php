                ...
                <div id="kt_app_toolbar" class="app-toolbar mt-5 py-3 py-lg-6">
                    ...
                    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                        ...
                        <div class="d-flex align-items-center gap-2 gap-lg-3">
                            ...
                            @can('{index_route}-create')
                                <a href="{{ route('{index_route}.create') }}" class="btn btn-sm fw-bold btn-primary">Add New {menu_title}</a>
                            @endcan
                            <a href="{{ route('{trash_index_route}.trash.records') }}" title="{{ $page_title }} Trash Records" class="btn btn-sm fw-bold btn-primary">Restore</a>
