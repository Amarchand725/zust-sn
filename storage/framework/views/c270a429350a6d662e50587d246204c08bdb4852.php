                                        ...
                                        <?php $__currentLoopData = $models; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($model->roles[0]->name != 'Admin'): ?>
                                                <tr id="id-<?php echo e($model->id); ?>">
                                                    ...
                                                    <td><?php echo e($model->roles[0]->name); ?></td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo e(route('admin.user.restore', $model->id)); ?>" data-toggle="tooltip" data-placement="top" title="Edit user" class="btn btn-primary btn-sm"><i class="fa fa-refresh"></i> Restore</a>
                                                    </td>
                                                </tr>
                                            <?php endif; ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\zust-sn\resources\views/admin/user/trash-index.blade.php ENDPATH**/ ?>