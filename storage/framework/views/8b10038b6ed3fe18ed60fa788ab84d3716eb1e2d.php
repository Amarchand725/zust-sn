        ...
        <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
            ...
            <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                ...
                <div class="w-lg-500px p-10">
                    ...
                    <form class="form w-100 " novalidate="novalidate" id="kt_password_reset_form" action="<?php echo e(route('password.email')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <!--begin::Heading-->
                        ...
                        <div class="d-flex flex-wrap justify-content-center pb-lg-0">
                            ...
                            <a href="<?php echo e(route('admin.login')); ?>" class="btn btn-light">Cancel</a>
                        </div>
                        <!--end::Actions-->
                    </form>
...
<?php echo $__env->make('admin.auth.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\admin-default\resources\views/admin/auth/forgot-password.blade.php ENDPATH**/ ?>