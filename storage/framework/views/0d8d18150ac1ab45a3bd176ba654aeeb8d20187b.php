    ...
    <div class="content-page-box-area">
        <div class="all-notifications-body">
            ...
            <div class="item d-flex justify-content-between align-items-center">
                <div class="figure">
                    <a href="my-profile.html"><img src="<?php echo e(asset('public/frontend')); ?>/assets/images/user/user-55.jpg" class="rounded-circle" alt="image"></a>
                </div>
                <div class="text">
            ...
            <div class="item d-flex justify-content-between align-items-center">
                <div class="figure">
                    <a href="my-profile.html"><img src="<?php echo e(asset('public/frontend')); ?>/assets/images/user/user-45.jpg" class="rounded-circle" alt="image"></a>
                </div>
                <div class="text">
            ...
            <div class="item d-flex justify-content-between align-items-center">
                <div class="figure">
                    <a href="my-profile.html"><img src="<?php echo e(asset('public/frontend')); ?>/assets/images/user/user-48.jpg" class="rounded-circle" alt="image"></a>
                </div>
                <div class="text">
            ...
            <div class="item d-flex justify-content-between align-items-center">
                <div class="figure">
                    <a href="my-profile.html"><img src="<?php echo e(asset('public/frontend')); ?>/assets/images/user/user-49.jpg" class="rounded-circle" alt="image"></a>
                </div>
                <div class="text">
            ...
            <div class="item d-flex justify-content-between align-items-center">
                <div class="figure">
                    <a href="my-profile.html"><img src="<?php echo e(asset('public/frontend')); ?>/assets/images/user/user-50.jpg" class="rounded-circle" alt="image"></a>
                </div>
                <div class="text">
            ...
            <div class="item d-flex justify-content-between align-items-center">
                <div class="figure">
                    <a href="my-profile.html"><img src="<?php echo e(asset('public/frontend')); ?>/assets/images/user/user-51.jpg" class="rounded-circle" alt="image"></a>
                </div>
                <div class="text">
            ...
            <div class="item d-flex justify-content-between align-items-center">
                <div class="figure">
                    <a href="my-profile.html"><img src="<?php echo e(asset('public/frontend')); ?>/assets/images/user/user-52.jpg" class="rounded-circle" alt="image"></a>
                </div>
                <div class="text">
            ...
            <div class="item d-flex justify-content-between align-items-center">
                <div class="figure">
                    <a href="my-profile.html"><img src="<?php echo e(asset('public/frontend')); ?>/assets/images/user/user-53.jpg" class="rounded-circle" alt="image"></a>
                </div>
                <div class="text">
            ...
            <div class="item d-flex justify-content-between align-items-center">
                <div class="figure">
                    <a href="my-profile.html"><img src="<?php echo e(asset('public/frontend')); ?>/assets/images/user/user-54.jpg" class="rounded-circle" alt="image"></a>
                </div>
                <div class="text">
                    <h4><a href="my-profile.html">Martha Wilkes</a></h4>
                    <span>Added a Photo in Graphic Design Group</span>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\zust-sn\resources\views/frontend/home/notification.blade.php ENDPATH**/ ?>