                ...
                <div id="kt_app_toolbar" class="app-toolbar mt-5 py-3 py-lg-6">
                    ...
                    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                        ...
                        <div class="d-flex align-items-center gap-2 gap-lg-3">
                            ...
                            @can('role-create')
                                <a href="{{ route('role.create') }}" class="btn btn-sm fw-bold btn-primary">Add New Role</a>
                            @endcan
                            <a href="{{ route('admin.role.trash.records') }}" title="Role All Trash Records" class="btn btn-sm fw-bold btn-primary">Restore</a>
