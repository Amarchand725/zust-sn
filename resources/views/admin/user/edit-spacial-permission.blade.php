    ...
    <div id="kt_app_content_container" class="app-container ">
        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="" class="collapse show">
                <!--begin::Form-->
                <form action="{{ route('admin.user.update-spacial-permission', $user->id) }}" id="regform" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    @csrf
                    {{ method_field('PATCH') }}
                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" disabled name="name" value="{{ $user->name }} ({{ $user->email }})" class="form-control form-control-lg form-control-solid" placeholder="Role name"/>
                                        ...
                                        <div class="col-lg-3">
                                            <label>
                                                @if(isset($direct_permissions))
                                                    {{ Form::checkbox('permission[]', $value->id, in_array($value->id, $direct_permissions) ? true : false, array('class' => 'name')) }} {{ ucfirst($value->name) }}
                                                @else
