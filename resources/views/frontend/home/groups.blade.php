                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-groups-card">
                            <div class="groups-image">
                                <a href="#">
                                    <img src="{{ asset('public/frontend') }}/assets/images/groups/groups-bg-2.jpg" alt="image">
                                </a>
                            </div>
                            <div class="groups-content">
                                <div class="groups-info d-flex justify-content-between align-items-center">
                                    <a href="#">
                                        <img src="{{ asset('public/frontend') }}/assets/images/groups/groups-2.jpg" alt="image">
                                    </a>
                                    <div class="text ms-3">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-groups-card">
                            <div class="groups-image">
                                <a href="#">
                                    <img src="{{ asset('public/frontend') }}/assets/images/groups/groups-bg-3.jpg" alt="image">
                                </a>
                            </div>
                            <div class="groups-content">
                                <div class="groups-info d-flex justify-content-between align-items-center">
                                    <a href="#">
                                        <img src="{{ asset('public/frontend') }}/assets/images/groups/groups-3.jpg" alt="image">
                                    </a>
                                    <div class="text ms-3">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-groups-card">
                            <div class="groups-image">
                                <a href="#">
                                    <img src="{{ asset('public/frontend') }}/assets/images/groups/groups-bg-4.jpg" alt="image">
                                </a>
                            </div>
                            <div class="groups-content">
                                <div class="groups-info d-flex justify-content-between align-items-center">
                                    <a href="#">
                                        <img src="{{ asset('public/frontend') }}/assets/images/groups/groups-4.jpg" alt="image">
                                    </a>
                                    <div class="text ms-3">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-groups-card">
                            <div class="groups-image">
                                <a href="#">
                                    <img src="{{ asset('public/frontend') }}/assets/images/groups/groups-bg-5.jpg" alt="image">
                                </a>
                            </div>
                            <div class="groups-content">
                                <div class="groups-info d-flex justify-content-between align-items-center">
                                    <a href="#">
                                        <img src="{{ asset('public/frontend') }}/assets/images/groups/groups-5.jpg" alt="image">
                                    </a>
                                    <div class="text ms-3">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-groups-card">
                            <div class="groups-image">
                                <a href="#">
                                    <img src="{{ asset('public/frontend') }}/assets/images/groups/groups-bg-6.jpg" alt="image">
                                </a>
                            </div>
                            <div class="groups-content">
                                <div class="groups-info d-flex justify-content-between align-items-center">
                                    <a href="#">
                                        <img src="{{ asset('public/frontend') }}/assets/images/groups/groups-6.jpg" alt="image">
                                    </a>
                                    <div class="text ms-3">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-groups-card">
                            <div class="groups-image">
                                <a href="#">
                                    <img src="{{ asset('public/frontend') }}/assets/images/groups/groups-bg-7.jpg" alt="image">
                                </a>
                            </div>
                            <div class="groups-content">
                                <div class="groups-info d-flex justify-content-between align-items-center">
                                    <a href="#">
                                        <img src="{{ asset('public/frontend') }}/assets/images/groups/groups-7.jpg" alt="image">
                                    </a>
                                    <div class="text ms-3">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-groups-card">
                            <div class="groups-image">
                                <a href="#">
                                    <img src="{{ asset('public/frontend') }}/assets/images/groups/groups-bg-8.jpg" alt="image">
                                </a>
                            </div>
                            <div class="groups-content">
                                <div class="groups-info d-flex justify-content-between align-items-center">
                                    <a href="#">
                                        <img src="{{ asset('public/frontend') }}/assets/images/groups/groups-8.jpg" alt="image">
                                    </a>
                                    <div class="text ms-3">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-groups-card">
                            <div class="groups-image">
                                <a href="#">
                                    <img src="{{ asset('public/frontend') }}/assets/images/groups/groups-bg-9.jpg" alt="image">
                                </a>
                            </div>
                            <div class="groups-content">
                                <div class="groups-info d-flex justify-content-between align-items-center">
                                    <a href="#">
                                        <img src="{{ asset('public/frontend') }}/assets/images/groups/groups-9.jpg" alt="image">
                                    </a>
                                    <div class="text ms-3">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-groups-card">
                            <div class="groups-image">
                                <a href="#">
                                    <img src="{{ asset('public/frontend') }}/assets/images/groups/groups-bg-10.jpg" alt="image">
                                </a>
                            </div>
                            <div class="groups-content">
                                <div class="groups-info d-flex justify-content-between align-items-center">
                                    <a href="#">
                                        <img src="{{ asset('public/frontend') }}/assets/images/groups/groups-10.jpg" alt="image">
                                    </a>
                                    <div class="text ms-3">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-groups-card">
                            <div class="groups-image">
                                <a href="#">
                                    <img src="{{ asset('public/frontend') }}/assets/images/groups/groups-bg-11.jpg" alt="image">
                                </a>
                            </div>
                            <div class="groups-content">
                                <div class="groups-info d-flex justify-content-between align-items-center">
                                    <a href="#">
                                        <img src="{{ asset('public/frontend') }}/assets/images/groups/groups-11.jpg" alt="image">
                                    </a>
                                    <div class="text ms-3">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-groups-card">
                            <div class="groups-image">
                                <a href="#">
                                    <img src="{{ asset('public/frontend') }}/assets/images/groups/groups-bg-12.jpg" alt="image">
                                </a>
                            </div>
                            <div class="groups-content">
                                <div class="groups-info d-flex justify-content-between align-items-center">
                                    <a href="#">
                                        <img src="{{ asset('public/frontend') }}/assets/images/groups/groups-12.jpg" alt="image">
                                    </a>
                                    <div class="text ms-3">
