<div class="right-sidebar-area" data-simplebar>
    ...
    <div class="recent-chat-box">
        ...
        <div class="chat-body" data-simplebar>
            ...
            <div class="chat-item">
                <a href="#"><img src="{{ asset('public/frontend') }}/assets/images/user/user-16.jpg" class="rounded-circle" alt="image"></a>
                <span class="name"><a href="#">Maria Smith</a></span>
                <span class="status-offline"></span>
            </div>
            <div class="chat-item">
                <a href="#"><img src="{{ asset('public/frontend') }}/assets/images/user/user-17.jpg" class="rounded-circle" alt="image"></a>
            ...
            <div class="chat-item">
                <a href="#"><img src="{{ asset('public/frontend') }}/assets/images/user/user-10.jpg" class="rounded-circle" alt="image"></a>
                <span class="name"><a href="#">Paul Enlow</a></span>
                <span class="status-offline"></span>
            </div>
        </div>
    ...
    <div class="recent-contact-box">
        ...
        <div class="contact-body" data-simplebar>
            <div class="contact-item">
                <a href="#"><img src="{{ asset('public/frontend') }}/assets/images/user/user-18.jpg" class="rounded-circle" alt="image"></a>
            ...
            <div class="contact-item">
                <a href="#"><img src="{{ asset('public/frontend') }}/assets/images/user/user-20.jpg" class="rounded-circle" alt="image"></a>
            ...
            <div class="contact-item">
                <a href="#"><img src="{{ asset('public/frontend') }}/assets/images/user/user-21.jpg" class="rounded-circle" alt="image"></a>
